...
namespace DuskOfTheUniverse
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        #region BLOOM_EFFECT_SETTINGS
        const float BLOOMTHRESHOLD = 0;
        const float BLURAMOUNT = 4;
        const float BLOOMAMOUNT = 4;
        const float BASEINTENSITY = 1;
        const float BLOOMSATURATION = 4;
        const float BASESATURATION = 2;
        #endregion
        ...
        /// <summary>
        /// BloomComponent class constructor
        /// </summary>
        /// <param name="game">The game this component is to belong to</param>
        ...
        /// <summary>
        /// Initialise method for the bloom component
        /// </summary>
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            parameters["BloomIntensity"].SetValue(BLOOMAMOUNT);
        ...
        #region PRIVATE_CALCULATION_METHODS
        /// <summary>
